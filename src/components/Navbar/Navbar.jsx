...
function Navbar() {
  return (
  <nav className='p-3 flex bg-gray-300 justify-between items-center fixed top-0 left-0 right-0 bg-transparent'>
    <div className='bg-[#747474] sm:p-1 rounded-3 ustify-between items-center'>
...
<div className='bg-[#747474] sm:p-1 rounded-3'>
